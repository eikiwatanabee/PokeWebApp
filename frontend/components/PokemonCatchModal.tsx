      ...
      >
        {phase === 'shake' && (
          <div className="animate-pokeball-shake">
            ...
            <p className="mt-4 text-lg font-bold text-gray-700">カチッ...カチッ...</p>
          </div>
        )}
        ...
        {phase === 'caught' && (
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl font-bold text-[#DC0A2D]">やった！</p>
          </div>
        )}
        ...
        {phase === 'reveal' && (
          <div className="animate-fade-in-up">
            ...
            <p className="text-gray-500 mt-1">No.{pokemon.pokemon_id}</p>
            <p className="text-lg font-bold text-[#DC0A2D] mt-4">
              ポケモンゲットだぜ！
            </p>
            <button
              onClick={onClose}
              className="mt-6 px-8 py-2.5 bg-[#DC0A2D] text-white rounded-full hover:bg-[#b8091f] transition-colors font-bold shadow-lg"
            >
              やったね！
            </button>
          </div>
